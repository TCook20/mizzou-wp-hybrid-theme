...
/**
 * Title: Hero (Default)
 * Slug: mizzou/banner-hero--default
 * Description:
	...
	<div class="wp-block-cover alignfull miz-hero">
		...
		<div class="wp-block-cover__inner-container">
			...
			<div class="wp-block-group miz-hero__content">
				...
				<!-- wp:heading {"placeholder":"Add a title...","textColor":"miz-gold","className":"miz-hero__title miz-text\u002d\u002dgold","fontFamily":"miz-graphik"} -->
				<h2 class="wp-block-heading miz-hero__title miz-text--gold has-miz-gold-color has-text-color has-miz-graphik-font-family"></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
		</div>
