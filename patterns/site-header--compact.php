<?php
/**
 * Title: Site Header (Mega Menu)
 * Slug: mizzou/site-header--compact
 * Description:
...
<header class="miz-header wp-block-mizzou-header">
	...
	<!-- wp:mizzou/header-section {"fillColor":"white","className":"miz-header\u002d\u002dcompact"} -->
	<div class="wp-block-mizzou-header-section miz-fill--white miz-header--compact">
		<div class="miz-container">
			...
			<!-- wp:mizzou/mega-menu {"overlayBackgroundColor":"#FFFFFF","className":"wp-block-mizzou-mega-menu miz-megamenu miz-expand"} /-->
		</div>
	</div>
	<!-- /wp:mizzou/header-section -->
</header>
