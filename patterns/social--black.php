<?php
/**
 * Title: Social (Black Variant)
 * Slug: mizzou/social--black
 * Description:
...
<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"miz-black","className":"miz-layer miz-layer\u002d\u002dbrand","layout":{"type":"default"}} -->
<section class="wp-block-group alignfull miz-layer miz-layer--brand has-miz-black-background-color has-background">
	...
	<div class="wp-block-group miz-container">
		...
		<div class="wp-block-group">
			<!-- wp:heading {"placeholder":"Get more M-I-Z in your newsfeed","textColor":"miz-gold","className":"miz-layer__title"} -->
		...
		<div class="wp-block-group">
			<!-- wp:social-links {"iconColor":"miz-gold","iconColorValue":"#F1B82D","size":"has-huge-icon-size","style":{"spacing":{"blockGap":{"left":"1rem"}}},"className":"is-style-logos-only"} -->
