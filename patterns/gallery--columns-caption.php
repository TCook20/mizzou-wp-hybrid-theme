<?php
/**
 * Title: Gallery (2 Columns with Caption)
 * Slug: mizzou/gallery--columns-caption
 * Description:
...
<section class="wp-block-group">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:33.33%">
			<!-- wp:group {"lock":{"move":false,"remove":true},"style":{"spacing":{"blockGap":"1.5rem"}},"layout":{"type":"flex","orientation":"vertical"}} -->
