<?php
/**
 * Title: Site Header (Dark Variant)
 * Slug: mizzou/site-header--dark
 * Description:
...
<!-- wp:mizzou/header {"title":"<?php echo get_bloginfo( 'name' ); ?>","url":"<?php echo get_bloginfo( 'url' ); ?>", "theme":"dark"} -->
<header class="miz-header miz-header--dark wp-block-mizzou-header">
	...
	<!-- wp:mizzou/header-section {{"fillColor":"black-600"}} -->
	<div class="wp-block-mizzou-header-section miz-fill--black-600">
		<div class="miz-container">
			<!-- wp:mizzou/masthead {"title":"<?php echo get_bloginfo( 'name' ); ?>","link":"<?php echo get_bloginfo( 'url' ); ?>", "variant":"dark"} /-->
		</div>
	</div>
	<!-- /wp:mizzou/header-section -->
